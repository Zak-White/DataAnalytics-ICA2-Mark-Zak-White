...
# Custom SQL Query 1 = Select specific Names from the project table

#QueryTerm1 <- "Galaxy"
#Query <- dbGetQuery(Projects, 'SELECT \"ProjectName\",\ 
 #                   FROM projects_df\ 
  #                  WHERE ProjectName\ 
  #                  LIKE QueryTerm1')
#Query
#specialID <- projectdevelopers_df$ProjectID
#projects_df <-projects_df %>% filter(specialID == 108)
#projects_df
