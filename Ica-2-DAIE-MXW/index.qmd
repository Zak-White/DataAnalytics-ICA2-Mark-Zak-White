...
AssetsProjects_df <- AssetsProjects_df %>% mutate(EndDate = mdy_hms(EndDate),StartDate = mdy_hms(StartDate)) %>% mutate(diff=as.numeric(difftime(EndDate, StartDate, units = "days"))) 
#EndDate <- 
